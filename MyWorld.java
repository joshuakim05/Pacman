...
public class MyWorld extends World
{
    ...
    private void prepare()
    {
        ...
        ball.setLocation(34,107);
        PacmanTurnPoint pacmanTurnPoint12 = new PacmanTurnPoint();
        addObject(pacmanTurnPoint12,34,107);
        ...
        removeObject(ball153);
        ball152.setLocation(218,317);
        removeObject(ball152);
        ball151.setLocation(217,297);
        removeObject(ball151);
        removeObject(ball150);
        removeObject(ball149);
        ball148.setLocation(219,241);
        removeObject(ball148);
        ball140.setLocation(218,223);
        removeObject(ball140);
        ball141.setLocation(242,221);
        removeObject(ball141);
        ball142.setLocation(264,221);
        removeObject(ball142);
        ball136.setLocation(291,221);
        removeObject(ball136);
        ball143.setLocation(313,221);
        removeObject(ball143);
        ball138.setLocation(356,200);
        ball144.setLocation(334,223);
        removeObject(ball144);
        ball139.setLocation(359,223);
        removeObject(ball139);
        ball145.setLocation(378,223);
        removeObject(ball145);
        ball146.setLocation(404,220);
        removeObject(ball146);
        ball147.setLocation(430,223);
        removeObject(ball147);
        ball167.setLocation(197,277);
        removeObject(ball167);
        ball166.setLocation(175,277);
        removeObject(ball166);
        removeObject(ball157);
        ball158.setLocation(427,258);
        removeObject(ball158);
        ball159.setLocation(427,276);
        removeObject(ball159);
        ball160.setLocation(425,296);
        removeObject(ball160);
        ball161.setLocation(427,314);
        removeObject(ball161);
        ball162.setLocation(428,334);
        removeObject(ball162);
        ball170.setLocation(242,336);
        removeObject(ball170);
        ball171.setLocation(264,336);
        removeObject(ball171);
        removeObject(ball172);
        ball173.setLocation(310,336);
        removeObject(ball173);
        ball174.setLocation(332,336);
        removeObject(ball174);
        ball175.setLocation(357,335);
        removeObject(ball175);
        ball176.setLocation(382,337);
        removeObject(ball176);
        ball177.setLocation(403,338);
        removeObject(ball177);
        ball163.setLocation(428,352);
        removeObject(ball163);
        ball164.setLocation(429,373);
        removeObject(ball164);
        ball154.setLocation(219,355);
        removeObject(ball154);
        ball155.setLocation(220,372);
        removeObject(ball155);
        ball168.setLocation(452,278);
        removeObject(ball168);
        ball169.setLocation(475,277);
        removeObject(ball169);
        ball138.setLocation(359,200);
        removeObject(ball138);
        ball137.setLocation(358,185);
        removeObject(ball137);
        ball134.setLocation(288,185);
        removeObject(ball134);
        ball135.setLocation(289,198);
        removeObject(ball135);
        ball217.setLocation(567,508);

        ball217.setLocation(565,508);
        PacmanTurnPoint pacmanTurnPoint15 = new PacmanTurnPoint();
        addObject(pacmanTurnPoint15,565,508);

        ball116.setLocation(498,509);
