...
public class MyWorld extends World
{
    ...
    //         topBottomLeftTP topBottomLeftTP = new topBottomLeftTP();
    //         addObject(topBottomLeftTP,607,104);
    ...
    //         topLeftTP topLeftTP = new topLeftTP();
    //         addObject(topLeftTP,429,163);
    //         topBottomRightTP topBottomRightTP2 = new topBottomRightTP();
    //         addObject(topBottomRightTP2,494,164);
    //         bottmLeftTP bottmLeftTP4 = new bottmLeftTP();
    //         addObject(bottmLeftTP4,613,163);
